...
module soc_system_mm_interconnect_0 (
	...
	wire  [127:0] pio_led_s1_agent_rf_source_data;                                                    // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [127:0] pio_led_s1_agent_rsp_fifo_out_data;                                                 // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire  [126:0] sysid_qsys_control_slave_agent_rp_data;                                             // sysid_qsys_control_slave_agent:rp_data -> router_007:sink_data
	...
	wire  [126:0] pio_led_s1_agent_rp_data;                                                           // pio_led_s1_agent:rp_data -> router_008:sink_data
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pio_led_s1_burst_adapter:sink0_valid
	wire  [126:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                              // pio_led_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_led_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pio_led_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pio_led_s1_burst_adapter:sink0_endofpacket
	wire          pio_led_s1_burst_adapter_source0_valid;                                             // pio_led_s1_burst_adapter:source0_valid -> pio_led_s1_agent:cp_valid
	wire  [126:0] pio_led_s1_burst_adapter_source0_data;                                              // pio_led_s1_burst_adapter:source0_data -> pio_led_s1_agent:cp_data
	...
	wire  [126:0] cmd_demux_003_src1_data;                                                            // cmd_demux_003:src1_data -> cmd_mux_002:sink1_data
	...
	wire  [126:0] cmd_demux_003_src2_data;                                                            // cmd_demux_003:src2_data -> cmd_mux_003:sink0_data
	wire          cmd_demux_003_src2_ready;                                                           // cmd_mux_003:sink0_ready -> cmd_demux_003:src2_ready
	wire    [4:0] cmd_demux_003_src2_channel;                                                         // cmd_demux_003:src2_channel -> cmd_mux_003:sink0_channel
	...
	wire  [126:0] cmd_demux_004_src1_data;                                                            // cmd_demux_004:src1_data -> cmd_mux_002:sink2_data
	...
	wire  [126:0] cmd_demux_004_src2_data;                                                            // cmd_demux_004:src2_data -> cmd_mux_003:sink1_data
	wire          cmd_demux_004_src2_ready;                                                           // cmd_mux_003:sink1_ready -> cmd_demux_004:src2_ready
	wire    [4:0] cmd_demux_004_src2_channel;                                                         // cmd_demux_004:src2_channel -> cmd_mux_003:sink1_channel
	...
	wire  [126:0] rsp_demux_002_src1_data;                                                            // rsp_demux_002:src1_data -> rsp_mux_003:sink1_data
	...
	wire  [126:0] rsp_demux_002_src2_data;                                                            // rsp_demux_002:src2_data -> rsp_mux_004:sink1_data
	...
	wire  [126:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> rsp_mux_003:sink2_data
	wire          rsp_demux_003_src0_ready;                                                           // rsp_mux_003:sink2_ready -> rsp_demux_003:src0_ready
	wire    [4:0] rsp_demux_003_src0_channel;                                                         // rsp_demux_003:src0_channel -> rsp_mux_003:sink2_channel
	...
	wire  [126:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_004:sink2_data
	wire          rsp_demux_003_src1_ready;                                                           // rsp_mux_004:sink2_ready -> rsp_demux_003:src1_ready
	wire    [4:0] rsp_demux_003_src1_channel;                                                         // rsp_demux_003:src1_channel -> rsp_mux_004:sink2_channel
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (clk_0_clk_clk),                                  //       cr0.clk
		.reset                 (pio_led_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
